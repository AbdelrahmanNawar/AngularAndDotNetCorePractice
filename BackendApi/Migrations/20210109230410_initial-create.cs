...
namespace BackendApi.Migrations
{
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DelivaryDate = table.Column<DateTime>(type: "date", nullable: false),
                    OrderDate = table.Column<DateTime>(type: "date", nullable: false),
                    TotalCost = table.Column<decimal>(type: "money", nullable: false),
                    OrderStatus = table.Column<int>(type: "int", nullable: false),
                    CreditCardNumber = table.Column<string>(type: "nchar(16)", fixedLength: true, maxLength: 16, nullable: true),
                    CreditCardExpirationDate = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "ShippingInfo",
                columns: new[] { "ShippingInfoId", "ShippingCost", "ShippingMethod" },
                values: new object[,]
                {
                    { 1, 1000m, 0 },
                    { 2, 750m, 1 },
